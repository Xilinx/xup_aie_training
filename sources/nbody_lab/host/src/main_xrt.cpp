...
int main(int argc, char ** argv) {
    ...
    //open xclbin
    Logger::flog(LMESSAGE,"loading nbody.xclbin ... ");
    ...
    auto xclbin = load_xclbin(dhdl, "nbody.xclbin");
    auto top = reinterpret_cast<const axlf*>(xclbin.data());
    Logger::flog(LMESSAGE,"loaded nbody.xclbin ... ");
    ...
    std::string filename = "../../aie/data/m2s_i.txt";
    ...
    for(int k=0; k<4; k++){
        filename = "../../aie/data/s2m_golden_i_k" + Logger::int2str(k,false) + ".txt";
    ...
    xrtDeviceClose(dhdl);
    Logger::flog(LMESSAGE,"Closed nbody.xclbin ...");
